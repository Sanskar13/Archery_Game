...
void draw()
{
    double x1[4], y1[4], y2[4], y3[4], y4[4];
    ...
    x1[0] = 100, x1[1] = 200, x1[2] = 200, x1[3] = 300 + xa;
    ...
    {
        xt[i] = x1[0] * pow((1 - u), 3) + x1[1] * 3 * (u)*pow((1 - u), 2) + x1[2] * 3 * u * u * (1 - u) + x1[3] * pow(u, 3);
...
int main(int argc, char** argv)
{
    ...
    glutAddMenuEntry("Red and Yellow", 1);
