...
void id1();
void id();
int waitTime = 1000; // 1000 milliseconds = 1 second
void timerCallback(int value)
{
    // Increment count and reset the position of the arrow
    count++;
    x = 25;
    y = 0;
    ...
    // Register the timer callback again for the next arrow
    glutTimerFunc(waitTime, timerCallback, 0);
}
...
void disa()
{
    ...
    else if ((x + 110 == 300) && (y >= 85 && y <= 115) && (!count11))
    {
        count11 = 1;
        x = 25;
        y = 0;
...
void display1(void)
{
    ...
    display_string(180, 350, "TUF GAMING @RNSIT", 1);
    display_string(215, 300, "PRO ARCHERY GAME", 1);
    ...
    display_string(100, 150, "LEFT CLICK AND THEN PRESS SPACE BAR TO START GAME", 2);
    glutPostRedisplay();
...
void keys(unsigned char k, int x, int y)
{
    ...
    case 'n': /* new game */
        ...
        n = 1;
        m = 3;
        count1 = 0, count2 = 0, count3 = 0, count4 = 0, count5 = 0, count6 = 0, count7 = 0, count8 = 0, count9 = 0, count10 = 0, count11 = 0;
        x = 25, y = 50;
...
int main(int argc, char** argv)
{
    ...
    glutAddMenuEntry("SANSKAR", 9);
    glutAddMenuEntry("SHUBHAM", 10);
    glutCreateMenu(game);
